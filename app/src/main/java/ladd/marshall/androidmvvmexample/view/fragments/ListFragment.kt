...
import ladd.marshall.androidmvvmexample.databinding.ListFragmentBinding
import ladd.marshall.androidmvvmexample.databinding.StartFragmentBinding
...
class ListFragment : Fragment(R.layout.list_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.employeeListLiveData.observe(viewLifecycleOwner) { employeeList ->
             ...
             * the update List.
             */
            (binding.recyclerView.adapter as EmployeeRecyclerViewAdapter).submitList(employeeList)
        }
    }
}
